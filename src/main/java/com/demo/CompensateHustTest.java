...
public class CompensateHustTest {
    ...
    private JSONObject updateDate(String entry,String data) {
        ...
        Map<String, Object> params = Dict.create()
                ...
                .set("data", data);
        return JSONObject.parseObject(HttpConnectionUtil.doPost(url, params));
    }
    ...
    private JSONObject getProcessDetails(String entry) {
        ...
        Map<String, Object> params = Dict.create()
                .set("access_token", token);
        JSONObject jsonObject = JSONObject.parseObject(HttpConnectionUtil.doGet(url, params));
    ...
    public String getToken(String scope) {
        ...
        Map<String, Object> params = Dict.create()
                ...
                .set("scope", scope);
        JSONObject jsonObject = JSONObject.parseObject(HttpConnectionUtil.doPost(url, headers, params));
        if (jsonObject != null) {
